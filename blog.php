...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:12 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <header class="header header-absolute"> 
      ...
      <!-- Top Bar End-->
      <nav class="navbar navbar-expand-lg bg-transparent border-0 shadow-0 navbar-light px-lg-5 "><a class="navbar-brand" href="index-2.html">Varkala</a>
    ...
    <!-- Hero Section-->
    <section class="hero hero-image" data-parallax="scroll" data-image-src="img/photo/blog-2.jpg" data-speed="0.5" data-position-x="center" data-position-y="center">
      <div class="container">
        <!-- Breadcrumbs -->
        <ol class="breadcrumb pl-0 no-border mb-0">
        ...
        <div class="hero-content">
          ...
          <div><p class="lead">As am hastily invited settled at limited civilly fortune me. Really spring in extent an by. Judge but built party world. Of so am he remember although required. Bachelor unpacked be advanced at. Confined in declared marianne is vicinity.</p></div>
        </div>
      </div>
    </section>
    <section class="py-6">
      <div class="container overflow-hidden">
        <div class="row mx-lg-n5">
          ...
          <!-- post-->
          <div class="col-lg-4 col-sm-6 mb-5 px-lg-5">
            <div data-aos="zoom-in"><a class="d-block mb-4" href="post.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/blog/matheus-ferrero-334418-unsplash.jpg" alt=""/></a>
...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:13 GMT -->
</html>