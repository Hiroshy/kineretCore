!(function (o) {
    ...
    (e.prototype.initCharts = function () {
        ...
        var t = {
            ...
            series: [
                { name: "Semana Actual", data: [10, 20, 15, 25, 20, 30, 20] },
                { name: "Semana Previa", data: [0, 15, 10, 30, 15, 35, 25] },
            ],
            colors: e,
            zoom: { enabled: !1 },
            legend: { show: !1 },
            xaxis: { type: "string", categories: ["Lun", "Mar", "Mie", "Jue", "Vie", "Sab", "Dom"], tooltip: { enabled: !1 }, axisBorder: { show: !1 } },
            yaxis: {
                labels: {
        ...
        t = {
            ...
            series: [
                ...
                { name: "Proyección", data: [89, 40, 32, 65, 59, 80, 81, 56, 89, 40, 65, 59] },
            ],
            zoom: { enabled: !1 },
            legend: { show: !1 },
            colors: e,
            xaxis: { categories: ["En", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Agos", "Sept", "Oct", "Nov", "Dic"], axisBorder: { show: !1 } },
            yaxis: {
                labels: {
                    formatter: function (e) {
                        return e + "k";
