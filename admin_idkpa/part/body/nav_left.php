        ...
        <ul class="metismenu side-nav">
            ...
            <li class="side-nav-item">
                ...
                <ul class="side-nav-second-level" aria-expanded="false">
                    <li>
                        <a href="apps-ecommerce-products.html">Ordenes</a>
                    </li>
                    <li>
                        <a href="apps-ecommerce-products-details.html">Cotizaciones</a>
                    </li>
                    <li>
                        <a href="apps-ecommerce-orders.html">Envios</a>
                    </li>
                    <li>
                        <a href="apps-ecommerce-orders-details.html">Créditos</a>
                    </li>
                    <li>
                        <a href="apps-ecommerce-customers.html">Devoluciones</a>
                    </li>
                    <li>
                        <a href="apps-ecommerce-shopping-cart.html">Facturación</a>
                    </li>
                    <li>
                        <a href="apps-ecommerce-checkout.html">Transacciones</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="side-nav-item">
                ...
                <ul class="side-nav-second-level" aria-expanded="false">
                    ...
                    <li>
                        <a href="apps-ecommerce-products-details.html">En linea</a>
                    </li>
                    <li>
                        <a href="apps-ecommerce-products-details.html">Segmentar</a>
                    </li>
                    <li>
                        <a href="apps-ecommerce-products-details.html">Grupo de clientes</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="side-nav-item">
                <a href="javascript: void(0);" class="side-nav-link">
                    <i class="mdi-page-layout-sidebar-left"></i>
                    <span> Diseño </span>
                    <span class="menu-arrow"></span>
                </a>
                <ul class="side-nav-second-level" aria-expanded="false">
                    <li class="side-nav-item">
                        ...
                        <ul class="side-nav-third-level" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);">Jerarquia</a>
                            </li>
                            <li>
                                <a href="javascript: void(0);">Bloques</a>
                            </li>
                            <li>
                                <a href="javascript: void(0);">Bloque dinámico</a>
                            </li>
                            <li>
                                <a href="javascript: void(0);">Widgets</a>
                            </li>
                            <li>
                                <a href="javascript: void(0);">Plantillas</a>
                            </li>
                        </ul>
                    </li>
                    <li class="side-nav-item">
            ...
            <li class="side-nav-item">
                ...
                <ul class="side-nav-second-level" aria-expanded="false">
                    <li>
                        <a href="//<?=$app['web_url_secure'].$app['base_url_admin']?>all">Products</a>
                    </li>
                    <li>
