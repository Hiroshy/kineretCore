...
<html lang="<?= $app['lenguage']; ?>">
    ...
    <body>
        ...
        <div class="position-relative py-6 overflow-hidden aos-init aos-animate" style="background-color: #fdf7e5;" data-aos="flip-up">
            ...
            <div class="container">
                <img class="position-absolute d-none d-sm-block" style="right: 5%; top: 0; max-width: 500px; z-index: 5;" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/lamps-transparent.png" alt="" />
                <div class="position-relative z-index-10">
                    ...
                    <h5 class="h2 font-weight-light mb-5">Our biggest sales this year — up to 60% off!</h5>
                    <a class="btn btn-outline-dark" href="#">Start shopping</a>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                        <div class="product" data-aos="zoom-in" data-aos-delay="0">
                            <div class="product-image mb-md-3">
                                ...
                                <a href="detail-1">
                                    <div class="product-swap-image">
                                        <img class="img-fluid product-swap-image-front" src="/img/product/0987188250_1_1_1.jpg" alt="product" /><img class="img-fluid" src="/img/product/0987188250_2_1_1.jpg" alt="product" />
                                    </div>
                                </a>
                                <div class="product-hover-overlay">
                                    ...
                                    <div>
                                        <a class="text-dark text-hover-primary mr-2" href="#">
                                            <svg class="svg-icon svg-icon-heavy">
                                                <use xlink:href="#heart-1">
                                                    <svg viewBox="0 0 64 64" id="heart-1">
                                                        <title>Heart</title>
                                        ...
                                        <a class="text-dark text-hover-primary text-decoration-none" href="#" data-toggle="modal" data-target="#quickView">
                                            <svg class="svg-icon svg-icon-heavy">
                                                <use xlink:href="#expand-1">
                                                    <svg viewBox="0 0 64 64" id="expand-1">
                                                        <title>Expand</title>
                                                        <desc>A line styled icon from Orion Icon Library.</desc>
                                                        <path
                                                            data-name="layer1"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#202020"
                                                            stroke-miterlimit="10"
                                                            d="M2 18V2h16m24 40l20 20M2 2l20 19.998"
                                                            stroke-linejoin="round"
                                                            stroke-linecap="round"
                                                            style="stroke: var(--layer2, #202020);"
                                                        ></path>
                            ...
                            <div class="position-relative">
                                <h3 class="text-base mb-1"><a class="text-dark" href="detail-1">White Tee</a></h3>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                        <div class="product" data-aos="zoom-in" data-aos-delay="0">
                            <div class="product-image mb-md-3">
                                <a href="detail-1">
                                    <div class="product-swap-image">
                                        <img class="img-fluid product-swap-image-front" src="/img/product/0950354513_1_1_1.jpg" alt="product" /><img class="img-fluid" src="/img/product/0950354513_2_1_1.jpg" alt="product" />
                                    </div>
                                </a>
                                <div class="product-hover-overlay">
                                    <a class="text-dark text-sm" href="#">
                            ...
                            <div class="position-relative">
                                <h3 class="text-base mb-1"><a class="text-dark" href="detail-1">Black blouse</a></h3>
                                <span class="text-gray-500 text-sm">$40.00</span>
                                <div class="product-stars text-xs">
                                    <i class="fa fa-star text-primary"></i><i class="fa fa-star text-primary"></i><i class="fa fa-star text-primary"></i><i class="fa fa-star text-muted"></i><i class="fa fa-star text-muted"></i>
                                </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                        <div class="product" data-aos="zoom-in" data-aos-delay="0">
                            <div class="product-image mb-md-3">
                                <div class="product-badge badge badge-primary">Sale</div>
                                <a href="detail-1">
                                    <div class="product-swap-image">
                                        <img class="img-fluid product-swap-image-front" src="/img/product/5161335400_1_1_1.jpg" alt="product" /><img class="img-fluid" src="/img/product/5161335400_2_3_1.jpg" alt="product" />
                                    </div>
                                </a>
                                <div class="product-hover-overlay">
                                    <a class="text-dark text-sm" href="#">
                            ...
                            <div class="position-relative">
                                <h3 class="text-base mb-1"><a class="text-dark" href="detail-1">College jacket</a></h3>
                                <span class="text-gray-500 text-sm">$40.00</span>
                                <div class="product-stars text-xs">
                                    <i class="fa fa-star text-primary"></i><i class="fa fa-star text-primary"></i><i class="fa fa-star text-primary"></i><i class="fa fa-star text-muted"></i><i class="fa fa-star text-muted"></i>
                                </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                        <div class="product" data-aos="zoom-in" data-aos-delay="0">
                            <div class="product-image mb-md-3">
                                <a href="detail-1">
                                    <div class="product-swap-image">
                                        <img class="img-fluid product-swap-image-front" src="/img/product/0027211800_1_2_1.jpg" alt="product" /><img class="img-fluid" src="/img/product/0027211800_2_1_1.jpg" alt="product" />
                                    </div>
                                </a>
                                <div class="product-hover-overlay">
                                    <a class="text-dark text-sm" href="#">
                            ...
                            <div class="position-relative">
                                <h3 class="text-base mb-1"><a class="text-dark" href="detail-1">Carrot-fit jeans</a></h3>
                                <span class="text-gray-500 text-sm">$40.00</span>
                                <div class="product-stars text-xs">
                                    <i class="fa fa-star text-primary"></i><i class="fa fa-star text-primary"></i><i class="fa fa-star text-primary"></i><i class="fa fa-star text-muted"></i><i class="fa fa-star text-muted"></i>
                                </div>
                                        ...
                                        <form id="buyForm_modal" action="#">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-lg-12 detail-option mb-5">
                                                    ...
                                                    <label class="btn btn-sm btn-outline-primary detail-option-btn-label" for="material_0_modal">
                                                        Hoodie
                                                        <input class="input-invisible" type="radio" name="material" value="value_0" id="material_0_modal" required />
                                                    </label>
                                                    <label class="btn btn-sm btn-outline-primary detail-option-btn-label" for="material_1_modal">
                                                        College
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-6">
                                                    <a href="#"> <i class="far fa-heart mr-2"></i>Add to wishlist </a>
                                                </div>
                                                <div class="col-6 text-right">
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item mr-2">
                                                            <a class="text-dark text-hover-primary" href="#"><i class="fab fa-facebook-f"> </i></a>
                                                        </li>
                                                        <li class="list-inline-item">
                                                            <a class="text-dark text-hover-primary" href="#"><i class="fab fa-twitter"> </i></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
        ...
        <div class="container mb-5">
            <div class="position-relative text-center" style="background: #eae0bd;">
                ...
                <div class="py-6 px-4">
                    <img class="position-absolute d-none d-md-block" style="right: 0; top: -50px; max-height: 100%; z-index: 5;" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/chair-transparent.png" alt="" />
                    <div class="position-relative z-index-10">
