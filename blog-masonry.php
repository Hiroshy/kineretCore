...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/blog-masonry.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:13 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="container mt-5">
      <section class="hero hero-boxed py-lg-7" data-parallax="scroll" data-image-src="img/photo/chris-murray-YGzEX5yLKeA-unsplash.jpg" data-speed="0.5" data-position-x="center">
        <div class="z-index-10">
          <!-- Breadcrumbs -->
          <ol class="breadcrumb pl-0undefined">
            <li class="breadcrumb-item"><a href="index-2.html">Home</a></li>
            <li class="breadcrumb-item active">Blog        </li>
          </ol>
          <h1 class="display-2 text-white">Blog</h1>
        </div>
      </section>
    </div>
    <section class="pt-5 pb-6">
      <div class="container overflow-hidden">
        <div class="mx-n3 mx-lg-n5 masonry-wrapper">
          <!-- post-->
          <div class="item col-lg-4 col-sm-6 mb-5 px-lg-5">
          ...
          <!-- post-->
          <div class="item col-lg-4 col-sm-6 mb-5 px-lg-5">
            <div data-aos="zoom-in"><a class="d-block mb-4" href="post.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/blog/kyle-loftus-596319-unsplash-cropped-2.jpg" alt=""/></a>
          ...
          <!-- post-->
          <div class="item col-lg-4 col-sm-6 mb-5 px-lg-5">
            <div data-aos="zoom-in"><a class="d-block mb-4" href="post.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/blog/averie-woodard-319832-unsplash-cropped.jpg" alt=""/></a>
              <h5 class="mb-2"><a class="text-dark" href="post.html">Autumn fashion tips and tricks          </a></h5>
              <p class="text-gray-500 text-sm"><a class="text-uppercase text-xs mr-2" href="#">Fashion and style</a>January 16, 2019</p>
            </div>
          </div>
          <!-- /post end-->
          <!-- post-->
          <div class="item col-lg-4 col-sm-6 mb-5 px-lg-5">
            <div data-aos="zoom-in"><a class="d-block mb-4" href="post.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/blog/photo-1534126511673-b6899657816a.jpg" alt=""/></a>
              <h5 class="mb-2"><a class="text-dark" href="post.html">Newest photo apps          </a></h5>
              <p class="text-gray-500 text-sm"><a class="text-uppercase text-xs mr-2" href="#">Fashion and style</a>January 16, 2019</p>
            </div>
          </div>
          <!-- /post end-->
          <!-- post-->
          <div class="item col-lg-4 col-sm-6 mb-5 px-lg-5">
            <div data-aos="zoom-in"><a class="d-block mb-4" href="post.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/blog/rahul-anil-214671-unsplash.jpg" alt=""/></a>
              <h5 class="mb-2"><a class="text-dark" href="post.html">Best books about Photography          </a></h5>
              <p class="text-gray-500 text-sm"><a class="text-uppercase text-xs mr-2" href="#">Fashion and style</a>January 16, 2019</p>
            </div>
          </div>
          <!-- /post end-->
    ...
    <script src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/vendor/jquery-parallax.js/parallax.min.js"></script>
    <!-- Some theme config-->
    <script>
      var options = {
          navbarExpandPx: 992
...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/blog-masonry.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:14 GMT -->
</html>