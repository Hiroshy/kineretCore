...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/checkout2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:33 GMT -->
<head>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="card-radio mb-4">
                  <label class="card-label" for="option0"></label>
                  <input class="card-radio-input" type="radio" name="shippping" id="option0" checked>
                  <div class="card">   
                    <div class="card-header">
                      <h6 class="mb-0">Usps next day</h6>
                    </div>
                    <div class="card-body">
              ...
              <div class="col-md-6">
                <div class="card-radio mb-4">
                  <label class="card-label" for="option1"></label>
                  <input class="card-radio-input" type="radio" name="shippping" id="option1">
                  <div class="card">   
                    <div class="card-header">
                      <h6 class="mb-0">Usps next day</h6>
                    </div>
                    <div class="card-body">
                      <p class="text-muted text-sm">Get it right on next day - fastest option possible.</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="card-radio mb-4">
                  <label class="card-label" for="option2"></label>
                  <input class="card-radio-input" type="radio" name="shippping" id="option2">
                  <div class="card">   
                    <div class="card-header">
                      <h6 class="mb-0">Usps next day</h6>
                    </div>
              ...
              <div class="col-md-6">
                <div class="card-radio mb-4">
                  <label class="card-label" for="option3"></label>
                  <input class="card-radio-input" type="radio" name="shippping" id="option3">
                  <div class="card">   
                    <div class="card-header">
                      <h6 class="mb-0">Usps next day</h6>
                    </div>
            ...
            <div class="my-5 d-flex justify-content-between flex-column flex-lg-row"><a class="btn btn-link text-muted" href="cart.html"> <i class="fa fa-angle-left mr-2"></i>Back to the addresses</a><a class="btn btn-dark" href="checkout3.html">Choose payment method<i class="fa fa-angle-right ml-2"></i></a></div>
          </div>
          <div class="col-lg-4">
            <div class="card mb-5"> 
              <div class="card-header">
...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/checkout2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:34 GMT -->
</html>