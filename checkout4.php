...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/checkout4.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:37 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <section class="hero py-6">
      <div class="container">
        ...
        <div class="hero-content">
          ...
          <div><p class="lead text-muted">Please review your order.</p></div>
        </div>
      </div>
    </section>
    <!-- Checkout-->
        ...
        <div class="row">
          <div class="col-lg-8">
            <ul class="custom-nav nav nav-pills mb-5">
              ...
              <li class="nav-item w-25"><a class="nav-link text-sm " href="checkout2.html">Delivery Method</a></li>
              <li class="nav-item w-25"><a class="nav-link text-sm " href="checkout3.html">Payment Method </a></li>
              <li class="nav-item w-25"><a class="nav-link text-sm active" href="checkout4.html">Order Review</a></li>
            </ul>
            <div class="mb-5">
              <div class="cart">
                  ...
                  <div class="cart-body">
                    ...
                    <div class="cart-item">
                      <div class="row d-flex align-items-center text-center">
                        <div class="col-6">
                          <div class="d-flex align-items-center"><a href="detail.html"><img class="cart-item-img" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/product-square-ian-dooley-347968-unsplash.jpg" alt="..."></a>
                            <div class="cart-title text-left"><a class="text-dark" href="detail.html"><strong>Skull Tee</strong></a><br><span class="text-muted text-sm">Size: Large</span><br><span class="text-muted text-sm">Colour: Green</span>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="cart-item">
                      <div class="row d-flex align-items-center text-center">
                        <div class="col-6">
                          <div class="d-flex align-items-center"><a href="detail.html"><img class="cart-item-img" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/product-square-kyle-loftus-596319-unsplash.jpg" alt="..."></a>
                            <div class="cart-title text-left"><a class="text-dark" href="detail.html"><strong>Transparent Blouse</strong></a><br><span class="text-muted text-sm">Size: Medium</span>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="cart-item">
                      <div class="row d-flex align-items-center text-center">
                        <div class="col-6">
                          <div class="d-flex align-items-center"><a href="detail.html"><img class="cart-item-img" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/product-square-serrah-galos-494312-unsplash.jpg" alt="..."></a>
                            <div class="cart-title text-left"><a class="text-dark" href="detail.html"><strong>White Tee</strong></a><br><span class="text-muted text-sm">Size: Medium</span>
                            </div>
                          </div>
                        </div>
                        <div class="col-2">$55.00</div>
            ...
            <div class="mb-5 d-flex justify-content-between flex-column flex-lg-row"><a class="btn btn-link text-muted" href="checkout3.html"> <i class="fa fa-angle-left mr-2"></i>Back to the delivery method</a><a class="btn btn-dark" href="checkout-confirmed.html">Place an order<i class="fa fa-angle-right ml-2"></i></a></div>
          </div>
          <div class="col-lg-4">
            <div class="card mb-5"> 
