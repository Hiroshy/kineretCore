...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/category-masonry.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:02 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-5"><a class="navbar-brand" href="index-2.html">Varkala</a>
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
          <ul class="navbar-nav mt-3 mt-lg-0">
            ...
            <li class="nav-item dropdown active"><a class="nav-link dropdown-toggle" id="shopDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Shop</a>
    ...
    <div class="container py-6">
      ...
      <div class="masonry-wrapper mx-n3">
        <div class="row">
          ...
          <div class="item col-xl-3 col-lg-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3">
                <div class="product-badge badge badge-secondary">Fresh</div><a href="detail-1.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/serrah-galos-494312-unsplash-cropped.jpg" alt="product"/></a>
          ...
          <div class="item col-xl-3 col-lg-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3"><a href="detail-1.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/0950354513_1_1_1.jpg" alt="product"/></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
          ...
          <div class="item col-xl-3 col-lg-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3">
                <div class="product-badge badge badge-primary">Sale</div><a href="detail-1.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/5161335400_1_1_1-cropped.jpg" alt="product"/></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
          ...
          <div class="item col-xl-3 col-lg-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3"><a href="detail-1.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/0027211800_1_2_1.jpg" alt="product"/></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
          ...
          <div class="item col-xl-3 col-lg-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3"><a href="detail-1.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/serrah-galos-494231-unsplash-cropped.jpg" alt="product"/></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
          ...
          <div class="item col-xl-3 col-lg-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3"><a href="detail-1.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/averie-woodard-319832-unsplash-cropped.jpg" alt="product"/></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
          ...
          <div class="item col-xl-3 col-lg-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3">
                <div class="product-badge badge badge-dark">Sold out</div><a href="detail-1.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/0364326148_1_1_1.jpg" alt="product"/></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
          ...
          <div class="item col-xl-3 col-lg-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3"><a href="detail-1.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/0931168712_1_1_1.jpg" alt="product"/></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
          ...
          <div class="item col-xl-3 col-lg-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3"><a href="detail-1.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/1000962306_1_1_1.jpg" alt="product"/></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
          ...
          <div class="item col-xl-3 col-lg-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3"><a href="detail-1.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/alex-holyoake-571682-unsplash-cropped.jpg" alt="product"/></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
          ...
          <div class="item col-xl-3 col-lg-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3"><a href="detail-1.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/0907168607_1_1_1.jpg" alt="product"/></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
          ...
          <div class="item col-xl-3 col-lg-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3"><a href="detail-1.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/5806513505_1_2_1.jpg" alt="product"/></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
          ...
          <div class="item col-xl-3 col-lg-4 col-6">
            <div class="product" data-aos="zoom-in" data-aos-delay="0">
              <div class="product-image mb-md-3">
                <div class="product-badge badge badge-primary">Sale</div><a href="detail-1.html"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/product/5161335400_1_1_1.jpg" alt="product"/></a>
                <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                    <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                      <use xlink:href="#retail-bag-1"> </use>
                    </svg><span class="d-none d-sm-inline">Add to cart</span></a>
    ...
    <script src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/vendor/masonry-layout/masonry.pkgd.min.js"></script>
    <script src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/vendor/imagesloaded/imagesloaded.pkgd.min.html"></script>
    <script src="js/masonry-init.8405a746.js"></script>
    <!-- Some theme config-->
    <script>
      var options = {
          navbarExpandPx: 992
...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/category-masonry.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:04 GMT -->
</html>