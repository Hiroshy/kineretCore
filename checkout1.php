...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/checkout1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:12 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <section class="hero py-6">
      <div class="container">
        ...
        <div class="hero-content">
          ...
          <div><p class="lead text-muted">Please fill in your address.</p></div>
        </div>
      </div>
    </section>
    <!-- Checkout-->
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <form action="#">
              ...
              <!-- /Shipping Address-->
              <div class="my-5 d-flex justify-content-between flex-column flex-lg-row"><a class="btn btn-link text-muted" href="cart.html"> <i class="fa fa-angle-left mr-2"></i>Back </a><a class="btn btn-dark" href="checkout2.html">Choose delivery method<i class="fa fa-angle-right ml-2"></i></a></div>
            </form>
          </div>
          <div class="col-lg-4">
            <div class="card mb-5"> 
