...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/about-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:16 GMT -->
<head>
    <meta charset="utf-8">
          ...
          <div class="col-lg-7 col-xl-6 order-lg-2 mb-3 mb-lg-0">
            <div class="d-flex align-items-center p-5 p-xl-6 bg-gray-100 h-100">
              <div>
                ...
                <h1 class="display-3 font-weight-bold mb-5">Frankie Kafka</h1>
                <div class="row">
                  <div class="col-xl-6">
                ...
                <div class="row">
                  <div class="col-xl-6">
                    ...
                    <p class="text-muted mb-5 mb-xl-0">123 Firebrigade St<br>San Antonio, CA<br>U.S.A.</p>
                  </div>
                  <div class="col-xl-6">
                    <h6 class="text-uppercase text-primary letter-spacing-3 mb-4">Company details</h6>
                    <p class="text-muted mb-0">Reg.Id: 15456456<br>VAT Id: 646643463546</p>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-5 col-xl-6 pr-lg-0 order-lg-1">
            <div class="dark-overlay mh-full-screen-with-header h-100"><img class="bg-image" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/photo/raoul-ortega-2JtF6pYAOOI-unsplash.jpg" alt=""></div>
          </div>
        </div>
      </div>
    </section>
