...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/checkout3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:37 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <section class="hero py-6">
      <div class="container">
        ...
        <div class="hero-content">
          ...
          <div><p class="lead text-muted">Choose the payment method.</p></div>
        </div>
      </div>
    </section>
    <!-- Checkout-->
        ...
        <div class="row">
          <div class="col-lg-8">
            <ul class="custom-nav nav nav-pills mb-5">
              ...
              <li class="nav-item w-25"><a class="nav-link text-sm active" href="checkout3.html">Payment Method </a></li>
              <li class="nav-item w-25"><a class="nav-link text-sm disabled" href="#">Order Review</a></li>
            </ul>
            <div class="mb-5">
              <div id="accordion" role="tablist">
                <div class="card border-0 shadow mb-3">
                  <div class="card-header accordion-header" id="headingOne" role="tab"><a class="accordion-link" data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Option one</a></div>
                ...
                <div class="card border-0 shadow mb-3">
                  <div class="card-header accordion-header" id="headingTwo" role="tab"><a class="accordion-link collapsed" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Paypal</a></div>
                  <div class="collapse" id="collapseTwo" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
                    <div class="card-body py-5">
                      <div class="custom-control custom-radio">
                        <input class="custom-control-input" id="payment-method-1" type="radio" name="payment">
                        <label class="custom-control-label" for="payment-method-1"> <span class="d-block h6 mt-1 mb-3"> Pay with PayPal</span><span class="text-muted text-sm">One morning, when Gregor Samsa woke from troubled dreams, he found himself transformed in his bed into a horrible vermin. He lay on his armour-like back, and if he lifted his head a little he could see his brown belly, slightly domed and divided by arches into stiff sections                    </span></label>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card border-0 shadow mb-3">
                  <div class="card-header accordion-header" id="headingThree" role="tab"><a class="accordion-link collapsed" data-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Pay on delivery</a></div>
                  <div class="collapse" id="collapseThree" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                    <div class="card-body py-5">
                      <div class="custom-control custom-radio">
                        <input class="custom-control-input" id="payment-method-2" type="radio" name="payment">
                        <label class="custom-control-label" for="payment-method-2"> <span class="d-block h6 mt-1 mb-3"> Pay on delivery</span><span class="text-muted text-sm">The bedding was hardly able to cover it and seemed ready to slide off any moment. His many legs, pitifully thin compared with the size of the rest of him, waved about helplessly as he looked. &quot;What's happened to me?&quot; he thought. It wasn't a dream.         </span></label>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="mb-5 d-flex justify-content-between flex-column flex-lg-row"><a class="btn btn-link text-muted" href="checkout2.html"> <i class="fa fa-angle-left mr-2"></i>Back to the delivery method</a><a class="btn btn-dark" href="checkout4.html">Continue to order review<i class="fa fa-angle-right ml-2"></i></a></div>
          </div>
          <div class="col-lg-4">
            <div class="card mb-5"> 
