...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:14 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="container py-6">
      <div class="row">
        ...
        <div class="col-xl-6">
          <h6 class="text-primary text-uppercase letter-spacing-5 mb-3"> About us</h6>
          <h1 class="display-3 font-weight-bold mb-5">We are Varkala</h1>
    ...
    <div class="container pt-4 pb-6">
      <div class="row mb-5">
        ...
        <div class="col-xl-8">
          <h6 class="text-primary text-uppercase letter-spacing-5 mb-3"> The old times</h6>
          <h2 class="display-3 font-weight-bold mb-5">History of Varkala</h2>
        </div>
      </div>
      <div class="row mb-5">
        <div class="col-sm-4"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/photo/raoul-ortega-2JtF6pYAOOI-unsplash.jpg" alt=""></div>
        <div class="col-sm-8 col-md-6 offset-md-1 d-flex align-items-center">
          <div>
      ...
      <div class="row mb-5">
        <div class="col-sm-8 col-md-7 col-lg-6 d-flex align-items-center">
          <div>
            <h6 class="text-uppercase text-muted letter-spacing-5 mb-1">Varkala today</h6>
            <h2 class="mb-4">And then we grew a bit</h2>
            <p class="text-muted">The bedding was hardly able to cover it and seemed ready to slide off any moment. His many legs, pitifully thin compared with the size of the rest of him, waved about helplessly as he looked. &quot;What's happened to me?&quot; he thought. It wasn't a dream.</p>
          </div>
        </div>
        <div class="col-sm-4 col-md-5 offset-lg-1"><img class="img-fluid" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/photo/clark-street-mercantile-P3pI6xzovu0-unsplash.jpg" alt=""></div>
      </div>
    </div>
    <section class="py-6 bg-gray-100">
      <div class="container">
        <div class="row">
          <div class="col-lg-5">
            <h2 class="mb-4">Varkala's Milestones</h2>
            <p class="text-lg text-muted mb-5 mb-lg-0">One morning, when Gregor Samsa woke from troubled dreams, he found himself transformed in his bed into a horrible vermin. He lay on his armour-like back, and if he lifted his head a little he could see his brown belly, slightly domed and divided by arches into stiff sections </p>
          </div>
    ...
    <section class="py-5">
      <div class="container">
        <div class="row">
          <div class="col-lg-5">
            <div class="p-5"><img class="img-fluid rounded-circle" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/avatar/avatar-0.jpg" alt=""></div>
          </div>
          <div class="col-lg-6 d-flex align-items-center">
            <div>
              <blockquote class="blockquote-icon mb-5">
                ...
                <h6 class="text-lg text-uppercase text-primary">— Frankie Kafka, Founder</h6>
              </blockquote>
    ...
    <div class="container pt-6 pb-5">
      <div class="row">
        ...
        <div class="col-xl-10">
          <h6 class="text-primary text-uppercase letter-spacing-5 mb-3"> Our team</h6>
          <h1 class="display-3 font-weight-bold mb-3">People</h1>
          <p class="text-muted mb-6">He must have tried it a hundred times, shut his eyes so that he wouldn't have to look at the floundering legs, and only stopped when he began to feel a mild, dull pain there that he had never felt before.</p>
          <div class="row">
            <div class="col-6 col-md-3 text-center mb-4"><img class="avatar avatar-xxl shadow-0 mb-3" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/avatar/avatar-0.jpg" alt="">
              <h4 class="h6 mb-1">Frankie Kafka</h4>
              <p class="text-sm text-muted">CEO &amp; Founder </p>
            </div>
            <div class="col-6 col-md-3 text-center mb-4"><img class="avatar avatar-xxl shadow-0 mb-3" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/avatar/avatar-1.jpg" alt="">
              <h4 class="h6 mb-1">Brittney Day</h4>
              <p class="text-sm text-muted">CTO </p>
            </div>
            <div class="col-6 col-md-3 text-center mb-4"><img class="avatar avatar-xxl shadow-0 mb-3" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/avatar/avatar-2.jpg" alt="">
              <h4 class="h6 mb-1">Kim Cervantes</h4>
              <p class="text-sm text-muted">Marketing </p>
            </div>
            <div class="col-6 col-md-3 text-center mb-4"><img class="avatar avatar-xxl shadow-0 mb-3" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/avatar/avatar-3.jpg" alt="">
              <h4 class="h6 mb-1">Massey Armstrong</h4>
              <p class="text-sm text-muted">Customer care </p>
            </div>
            <div class="col-6 col-md-3 text-center mb-4"><img class="avatar avatar-xxl shadow-0 mb-3" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/avatar/avatar-4.jpg" alt="">
              <h4 class="h6 mb-1">B.J. Petersen</h4>
              <p class="text-sm text-muted">E-commerce </p>
            </div>
            <div class="col-6 col-md-3 text-center mb-4"><img class="avatar avatar-xxl shadow-0 mb-3" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/avatar/avatar-5.jpg" alt="">
              <h4 class="h6 mb-1">Mayra Holman</h4>
              <p class="text-sm text-muted">Customer care </p>
            </div>
            <div class="col-6 col-md-3 text-center mb-4"><img class="avatar avatar-xxl shadow-0 mb-3" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/avatar/avatar-6.jpg" alt="">
              <h4 class="h6 mb-1">Gabriel Fisher</h4>
              <p class="text-sm text-muted">Customer care </p>
            </div>
            <div class="col-6 col-md-3 text-center mb-4"><img class="avatar avatar-xxl shadow-0 mb-3" src="../../../d19m59y37dris4.cloudfront.net/varkala/1-2/img/avatar/avatar-7.jpg" alt="">
      ...
      <div class="container">
        ...
        <div class="swiper-container brands-slider">
          <div class="swiper-wrapper pb-5">
            <!-- item-->
            <div class="swiper-slide h-auto d-flex align-items-center justify-content-center"><img class="img-fluid w-6rem opacity-7" src="https://d19m59y37dris4.cloudfront.net/varkala/1-2/img/brand/brand-1.svg" alt="Brand 1"></div>
            <!-- item-->
            <div class="swiper-slide h-auto d-flex align-items-center justify-content-center"><img class="img-fluid w-6rem opacity-7" src="https://d19m59y37dris4.cloudfront.net/varkala/1-2/img/brand/brand-2.svg" alt="Brand 2"></div>
            <!-- item-->
            <div class="swiper-slide h-auto d-flex align-items-center justify-content-center"><img class="img-fluid w-6rem opacity-7" src="https://d19m59y37dris4.cloudfront.net/varkala/1-2/img/brand/brand-3.svg" alt="Brand 3"></div>
            <!-- item-->
            <div class="swiper-slide h-auto d-flex align-items-center justify-content-center"><img class="img-fluid w-6rem opacity-7" src="https://d19m59y37dris4.cloudfront.net/varkala/1-2/img/brand/brand-4.svg" alt="Brand 4"></div>
            <!-- item-->
            <div class="swiper-slide h-auto d-flex align-items-center justify-content-center"><img class="img-fluid w-6rem opacity-7" src="https://d19m59y37dris4.cloudfront.net/varkala/1-2/img/brand/brand-5.svg" alt="Brand 5"></div>
            <!-- item-->
            <div class="swiper-slide h-auto d-flex align-items-center justify-content-center"><img class="img-fluid w-6rem opacity-7" src="https://d19m59y37dris4.cloudfront.net/varkala/1-2/img/brand/brand-6.svg" alt="Brand 6"></div>
            <!-- item-->
            <div class="swiper-slide h-auto d-flex align-items-center justify-content-center"><img class="img-fluid w-6rem opacity-7" src="https://d19m59y37dris4.cloudfront.net/varkala/1-2/img/brand/brand-1.svg" alt="Brand 1"></div>
            <!-- item-->
            <div class="swiper-slide h-auto d-flex align-items-center justify-content-center"><img class="img-fluid w-6rem opacity-7" src="https://d19m59y37dris4.cloudfront.net/varkala/1-2/img/brand/brand-2.svg" alt="Brand 2"></div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-10 mx-auto text-center">
            <h2 class="mb-6">At Varkala, we want the right choice to be as easy as putting on a great T-shirt</h2>
          </div>
...
<!-- Mirrored from demo.bootstrapious.com/varkala/1-2/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Feb 2021 02:43:16 GMT -->
</html>